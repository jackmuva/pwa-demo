...
#ifndef PLAUDPLUGIN_SWIFT_H
#define PLAUDPLUGIN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PlaudPlugin",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// Capacitor auto-registers any class that is <code>@objc</code>, subclasses <code>CAPPlugin</code>, and
/// conforms to <code>CAPBridgedPlugin</code> — the same mechanism the bluetooth-le plugin uses.
/// The JS side reaches this via <code>registerPlugin('PlaudSdk')</code>.
/// This first cut wires the connection lifecycle round-trip: <code>initSDK</code> → <code>startScan</code>,
...
/// on-device.
SWIFT_CLASS("_TtC11PlaudPlugin14PlaudSdkPlugin")
@interface PlaudSdkPlugin
@end
